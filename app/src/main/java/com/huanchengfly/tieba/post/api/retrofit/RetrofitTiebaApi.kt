...
object RetrofitTiebaApi {
    ...
    private fun oaidPayload(): String? =
        App.Config.encodedOAID.takeIf { it.isNotBlank() }?.let { OAID().toJson() }

    private fun zidValue(): String? =
        AccountUtil.getAccountInfo { zid }?.takeIf { !it.isNullOrBlank() }
    ...
    val NEW_TIEBA_API: NewTiebaApi by lazy {
        createJsonApi<NewTiebaApi>(
            ...
            CommonHeaderInterceptor(
                Header.USER_AGENT to { ClientVersion.TIEBA_V8_NEW.androidUserAgent },
            ...
            defaultCommonParamInterceptor + CommonParamInterceptor(
                ...
                Param.CLIENT_VERSION to { ClientVersion.TIEBA_V8_NEW.version }
            ),
            stParamInterceptor,
        )
    }
    ...
    val WEB_TIEBA_API: WebTiebaApi by lazy {
        createJsonApi<WebTiebaApi>("https://tieba.baidu.com/",
            CommonHeaderInterceptor(
                Header.USER_AGENT to { getUserAgent("${ClientVersion.TIEBA_V11.tiebaUserAgentPath} skin/default") },
    ...
    val HYBRID_TIEBA_API: AppHybridTiebaApi by lazy {
        createJsonApi<AppHybridTiebaApi>("https://tieba.baidu.com/",
            CommonHeaderInterceptor(
                Header.USER_AGENT to { getUserAgent("${ClientVersion.TIEBA_V12_POST.tiebaUserAgentPath} skin/default") },
                Header.HOST to { "tieba.baidu.com" },
                Header.PRAGMA to { "no-cache" },
    ...
    val MINI_TIEBA_API: MiniTiebaApi by lazy {
        createJsonApi<MiniTiebaApi>(
            ...
            defaultCommonHeaderInterceptor,
            CommonHeaderInterceptor(
                Header.USER_AGENT to { ClientVersion.TIEBA_V7_MINI.androidUserAgent },
                Header.CUID to { UIDUtil.finalCUID },
            ...
            defaultCommonParamInterceptor + CommonParamInterceptor(
                ...
                Param.CLIENT_VERSION to { ClientVersion.TIEBA_V7_MINI.version },
    ...
    val OFFICIAL_TIEBA_API: OfficialTiebaApi by lazy {
        createJsonApi<OfficialTiebaApi>(
            "https://c.tieba.baidu.com/",
            CommonHeaderInterceptor(
                Header.USER_AGENT to { ClientVersion.TIEBA_V12_OFFICIAL.androidUserAgent },
            ...
            defaultCommonParamInterceptor + CommonParamInterceptor(
                ...
                Param.CLIENT_VERSION to { ClientVersion.TIEBA_V12_OFFICIAL.version },
                Param.CUID_GALAXY3 to { UIDUtil.getAid() },
                Param.OAID to { oaidPayload() },
            ),
            stParamInterceptor,
        )
    }
    ...
    val OFFICIAL_PROTOBUF_TIEBA_API: OfficialProtobufTiebaApi by lazy {
        createProtobufApi<OfficialProtobufTiebaApi>(
            ...
            CommonHeaderInterceptor(
                ...
                Header.CUID_GID to { "" },
                Header.CUID_GALAXY3 to { UIDUtil.getAid() },
                Header.USER_AGENT to { ClientVersion.TIEBA_V11.androidUserAgent },
    ...
    val OFFICIAL_PROTOBUF_TIEBA_V12_API: OfficialProtobufTiebaApi by lazy {
        createProtobufApi<OfficialProtobufTiebaApi>(
            ...
            CommonHeaderInterceptor(
                ...
                Header.CUID_GID to { "" },
                Header.CUID_GALAXY3 to { UIDUtil.getAid() },
                Header.USER_AGENT to { getUserAgent(ClientVersion.TIEBA_V12.tiebaUserAgentPath) },
                Header.X_BD_DATA_TYPE to { "protobuf" },
            ),
            stParamInterceptor,
        )
...
//                Header.CLIENT_TYPE to { "2" },
                ...
                Header.CUID_GID to { "" },
                Header.CUID_GALAXY3 to { UIDUtil.getAid() },
                Header.USER_AGENT to { getUserAgent(ClientVersion.TIEBA_V12_POST.tiebaUserAgentPath) },
                Header.X_BD_DATA_TYPE to { "protobuf" },
            ),
            defaultCommonParamInterceptor - Param.OS_VERSION + CommonParamInterceptor(
