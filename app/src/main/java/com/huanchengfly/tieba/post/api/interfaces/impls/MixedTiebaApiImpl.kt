...
object MixedTiebaApiImpl : ITiebaApi {
    ...
    override fun webUploadPic(photoInfoBean: PhotoInfoBean): Call<WebUploadPicBean> {
        ...
        try {
            App.INSTANCE.contentResolver.openInputStream(photoInfoBean.fileUri)?.use { inputStream ->
                base64 = ImageUtil.imageToBase64(inputStream)
            }
        } catch (e: IOException) {
            e.printStackTrace()
            base64 = null
    ...
    override fun topicDetailFlow(
        ...
        return RetrofitTiebaApi.HYBRID_TIEBA_API.topicDetailFlow(
            topicId = topicId,
            topicName = topicName,
            page = page
        )
