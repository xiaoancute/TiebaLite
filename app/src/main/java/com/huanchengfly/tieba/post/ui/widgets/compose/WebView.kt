...
fun WebView(
    ...
    SimplePredictiveBackHandler(enabled = captureBackPresses && navigator.canGoBack) {
        webView?.goBack()
    }
...
open class AccompanistWebChromeClient : WebChromeClient() {
    ...
    override fun onProgressChanged(view: WebView, newProgress: Int) {
        ...
        state.loadingState = if (newProgress == 100) Finished else Loading(newProgress / 100.0f)
    }
}
