...
class AppFontSizeActivity : BaseActivity() {
    ...
    private val collapsingToolbar: CollapsingToolbarLayout by lazy { findViewById(R.id.collapsing_toolbar) }
    private val seekBar: RulerSeekBar by lazy { findViewById(R.id.app_font_size_seekbar) }
    private val sizeText: TextView by lazy { findViewById(R.id.app_font_size_text) }
    private val chatBubblesRv: RecyclerView by lazy { findViewById(R.id.app_font_size_bubbles) }
