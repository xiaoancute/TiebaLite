...
fun buildCommonRequest(
    ...
    ClientVersion.TIEBA_V7_MINI,
    ClientVersion.TIEBA_V8_MINI,
    ClientVersion.TIEBA_V8_NEW,
    ClientVersion.TIEBA_V11 -> {
        CommonRequest(
            ...
            model = Build.MODEL,
            net_type = 1,
            oaid = App.Config.encodedOAID.takeIf { it.isNotBlank() }?.let { OAID().toJson() },
            pversion = "1.0.3",
    ...
    ClientVersion.TIEBA_V12_OFFICIAL,
    ClientVersion.TIEBA_V12 -> {
        CommonRequest(
            ...
            z_id = AccountUtil.getAccountInfo { zid }?.takeIf { !it.isNullOrBlank() }
        )
    }
    ...
    ClientVersion.TIEBA_V12_POST -> {
        CommonRequest(
            ...
            model = Build.MODEL,
            net_type = 1,
            oaid = App.Config.encodedOAID.takeIf { it.isNotBlank() },
            personalized_rec_switch = 1,
            pversion = "1.0.3",
            q_type = 0,
            sample_id = ClientUtils.sampleId,
